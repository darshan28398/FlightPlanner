...
public class Akash_Vishvajit_Karan_Selected_Flight {
    ...
    //Constructor
    public Akash_Vishvajit_Karan_Selected_Flight(int tn, int tc){
        flightIndex = tn;
        travelClass = tc;
    }
    ...
    public Akash_Vishvajit_Karan_Selected_Flight() {
    }
